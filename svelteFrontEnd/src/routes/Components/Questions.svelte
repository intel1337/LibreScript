<script>
    ...
    async function loadPosts() {
        try {
            ...
            allPosts = Array.isArray(result && result.$values) ? result.$values : [];
...
<section class="questions-section">
    ...
    <div class="desktop-view">
        <table class="questions-table">
            ...
            <tbody>
                {#if postsLoading}
                    <tr><td colspan="5" style="text-align:center; color:#888;">Loading questions...</td></tr>
                {:else if postsError}
                    <tr><td colspan="5" style="text-align:center; color:#c00;">Error loading questions: {postsError.message}</td></tr>
                {:else if posts.length === 0}
                    <tr><td colspan="5" style="text-align:center; color:#888;">No questions found matching your filters.</td></tr>
                {:else}
