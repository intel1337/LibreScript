...
// Objet métier d'un Commentaire
{
    public class Comment
    {
        ...
        public Post Post { get; set; } // Post auquel le commentaire est associé

        public int UserId { get; set; } // ID de l'utilisateur qui a créé le commentaire
        public User User { get; set; } // Utilisateur qui a créé le commentaire

        public int? ParentCommentId { get; set; } // ID du commentaire parent si c'est une réponse à un autre commentaire
        public Comment? ParentComment { get; set; } // Commentaire parent si c'est une réponse

        public ICollection<Comment> Replies { get; set; } = new List<Comment>(); // Collection de réponses à ce commentaire
    }
} 